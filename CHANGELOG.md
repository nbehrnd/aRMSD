...
**Bugfixes**
          ...
          - Updating the information that debcollector-aRMSD.py facilitating the
            fetch and installation of dependencies of aRMSD equally works under
...
**Improvements**
         ...
         - deployment of aRMSD under Linux Debian 9 (buster/sid) is facilitated
           by a script collecting and installing the *.deb dependencies
         - provision of an initial, illustrated primer about the program
